...
When we implement a bifactor-style model—one general attitude factor plus the specific method factors—we get good fit (CFI = 0.98, TLI = 0.97, RMSEA = 0.03, SRMR = 0.03) but a radically different picture:
...
See also <https://replicationindex.com/2025/12/02/is-the-implicit-association-test-too-big-to-fail/>
